...
class MainMenu:
    MAIN_OPTIONS: List[Tuple[str, str]] = [
        ...
        ("5", "Creación de histograma de frecuencias de la columna 'device_horizontal_accuracy'"), 
        ("6", "Creación de histograma de frecuencias de la columnsa 'identifier'"),
    ...
    @staticmethod
    def display_main_menu(name: str="", converted_count: Optional[int] = None) -> str:
        print("\n" + "=" * 50)
